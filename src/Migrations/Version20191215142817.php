 ...
 */
final class Version20191215142817 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE adress_event (adress_id INT NOT NULL, event_id INT NOT NULL, INDEX IDX_336C89A18486F9AC (adress_id), INDEX IDX_336C89A171F7E88B (event_id), PRIMARY KEY(adress_id, event_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE adress_event ADD CONSTRAINT FK_336C89A18486F9AC FOREIGN KEY (adress_id) REFERENCES adress (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE adress_event ADD CONSTRAINT FK_336C89A171F7E88B FOREIGN KEY (event_id) REFERENCES event (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adress_event DROP FOREIGN KEY FK_336C89A18486F9AC');
        $this->addSql('ALTER TABLE adress DROP FOREIGN KEY FK_5CECC7BE8BAC62AF');
        $this->addSql('ALTER TABLE adress_event DROP FOREIGN KEY FK_336C89A171F7E88B');
        $this->addSql('DROP TABLE adress');
        $this->addSql('DROP TABLE adress_event');
